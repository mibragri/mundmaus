...
test.describe('OTA Update UI flow', () => {
  ...
  test('3. if no updates and online, shows "Alles auf dem neuesten Stand"', async ({ page }) => {
    ...
    await expect(updInfo).toContainText('Alles auf dem neuesten Stand', { timeout: 15_000 });
  });
