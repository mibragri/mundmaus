...
<span id="ws-chip" title="Verbindung zum Geraet" style="display:inline-flex;align-items:center;gap:4px;background:rgba(212,42,42,.15);border:1px solid #d42a2a;border-radius:12px;padding:2px 10px;font-size:.8em"><span id="ws-dot" style="width:6px;height:6px;border-radius:50%;background:#d42a2a"></span><span id="ws-text">Verbunden</span></span></div>
<script>
