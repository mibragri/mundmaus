...
&nbsp;|&nbsp; <span id="ws-dot" style="display:inline-block;width:8px;height:8px;border-radius:50%;background:#d42a2a;vertical-align:middle"></span> Live</div>
<script>
